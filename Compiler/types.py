...
class custom_sfix_field(sfix):
    ...
    def __abs__(self):
        """ Absolute value. """
        return (self < custom_sfix_field(0)).if_else(-self, self)
    

class custom_sfix_ring(sfix):
    ...
    def __abs__(self):
        """ Absolute value. """
        return (self < custom_sfix_ring(0)).if_else(-self, self)
